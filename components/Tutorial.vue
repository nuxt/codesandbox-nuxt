    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
        ...
        <p class="mt-2 text-gray-600">
          This starter is composed of different modules:
        </p>
        <ul class="text-gray-600 mt-1 list-disc list-inside">
          <li>
            <a
              href="https://nitro.nuxtjs.org"
              target="_blank"
              class="text-green-500 hover:underline"
              >@nuxt/nitro</a
            >, the next-generation engine that powers Nuxt 3.
          </li>
          <li>
            <a
              ...
              >@nuxt/image</a
            >
            to enjoy optimised images from the beginning.
          </li>
          <li>
            <a
              ...
              >@nuxtjs/pwa</a
            >
            for a zero config PWA solution.
          </li>
        </ul>
        <p class="mt-2 text-gray-600">
          Other Nuxt modules can be found on
          <a
            href="https://modules.nuxtjs.org"
            target="_blank"
            class="text-green-500 hover:underline"
            >modules.nuxtjs.org</a
          >
        </p>
